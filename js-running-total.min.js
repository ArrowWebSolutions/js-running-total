var Calculations=new function(){this._simple=function(t,i){if(t.length<=0)return 0;var e=t.slice(0),s=parseFloat(e.shift().getValue());s=isNaN(s)?0:s;for(var n=0;n<e.length;n++){var r=parseFloat(e[n].getValue());switch(i){case"+":s+=r;break;case"-":s-=r;break;case"*":s*=r;break;case"/":s/=r;break;case"^":s=Math.pow(s,r);break;case"min":s=Math.min(s,r);break;case"max":s=Math.max(s,r)}}return s},this.sum=function(t){return this._simple(t,"+")},this.subtract=function(t){return this._simple(t,"-")},this.multiply=function(t){return this._simple(t,"*")},this.divide=function(t){return this._simple(t,"/")},this.power=function(t){return this._simple(t,"^")},this.pow=function(t){return this.power(t)},this.max=function(t){return this._simple(t,"max")},this.min=function(t){return this._simple(t,"min")}};
...
var Formatter=new function(){this.defaultOptions={thousandsSeparator:",",decimalPoint:".",precision:0,currencySymbol:"£",percentageSymbol:"%",invalidValue:0},this.format=function(e,t,n){return"function"==typeof t?t(e,n):this[t](e,n)},this.number=function(e,t){t=this._extend(this.defaultOptions,t);var n=parseFloat(e);(isNaN(n)||!isFinite(n))&&(n=t.invalidValue);var i=this._toFixed(n,t.precision,t.decimalPoint);return this._addSeparators(i,t.thousandsSeparator,t.decimalPoint)},this.currency=function(e,t){"undefined"==typeof t&&(t={}),"undefined"==typeof t.precision&&(t.precision=2);var n=this.number(e,t);return t=this._extend(this.defaultOptions,t),t.currencySymbol+n},this.percentage=function(e,t){"undefined"==typeof t&&(t={}),"undefined"==typeof t.percentageMultiplyer&&(t.percentageMultiplyer=100);var n=parseFloat(e);n*=t.percentageMultiplyer;var i=this.number(n,t);return t=this._extend(this.defaultOptions,t),i+t.percentageSymbol},this._toFixed=function(e,t,n){return"undefined"==typeof n&&(n=this.defaultOptions.decimalPoint),e.toFixed(t).replace(".",n)},this._addSeparators=function(e,t,n){"undefined"==typeof t&&(t=this.defaultOptions.thousandsSeparator),"undefined"==typeof n&&(n=this.defaultOptions.decimalPoint),e+="";for(var i=e.split(n),r=i[0],a=i.length>1?n+i[1]:"",o=/(\d+)(\d{3})/;o.test(r);)r=r.replace(o,"$1"+t+"$2");return r+a},this._extend=function(e,t){if(e&&t){var n={};for(var i in e)n[i]=e[i];for(var i in t)n[i]=t[i];return n}return e}};
